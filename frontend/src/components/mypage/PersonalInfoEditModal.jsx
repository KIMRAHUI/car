...
const PersonalInfoEditModal = ({ onClose }) => {
    ...
    /*useEmailAuth 연결: count를 통해 인증 횟수를 관리*/
    const {
        timeLeft,
        isTimerActive,
        isVerified,
    ...
    /*이메일 발송 통합 핸들러*/
    const handleEmailRequest = async (isRetry = false) => {
    ...
    const handleUpdateInfo = () => {
        ...
        xhr.open('POST', 'api/mypage/update');
    ...
    return (
        <>
            <div className="modal-overlay" onClick={onClose}>
                {/* 첫 발송(count 1)일 때는 문구만 노출하여 자연스럽게 넘어가고,
                    재전송(count 2 이상)부터는 (n/10) 숫자를 노출하여 정보를 제공
                */}
                        ...
                        <div className="edit-section">
                            ...
                            <div className="input-with-btn">
                                ...
                                <button
                                    ...
                                    onClick={() => handleEmailRequest(false)}
