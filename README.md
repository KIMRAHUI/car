...
프론트엔드, 백엔드 비즈니스 로직, 그리고 AI 모델 추론 파이프라인의 **결합도를 완벽하게 분리(Decoupled Philosophy)**하여 수평 확장과 유지보수 용이성을 확보했습니다[cite: 2]. 또한 **Cloudflare**를 앞단에 두어 DNS 관리 및 보안/프록시 경로를 최적화했습니다.
