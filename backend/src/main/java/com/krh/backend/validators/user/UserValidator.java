...
public class UserValidator {
    ...
    public static final String PASSWORD_REGEX = "^[\\da-zA-Z`~!@#$%^&*()\\-_=+\\[{\\]}\\\\|;:'\",<.>/?]{8,16}$"; // 보안 강화: 8자 이상
    ...
    public static boolean validatePassword(String password) {
        return password != null &&
                ValidatorUtils.isLengthInBetween(password,8,16) &&
